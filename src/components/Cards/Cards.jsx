            ...
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xm={12} md={3}>
                    <CardContent>
                        ...
                        <Typography variant="h5"><CountUp start={0} end={confirmed.value} duration={3} separation=","></CountUp></Typography>
                ...
                <Grid item component={Card}  xm={12} md={3}>
                    <CardContent>
                        ...
                        <Typography variant="h5"><CountUp start={0} end={recovered.value} duration={3} separation=","></CountUp></Typography>
                        <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
                ...
                <Grid item component={Card}  xm={12} md={3}>
                    <CardContent>
                        ...
                        <Typography variant="h5"><CountUp start={0} end={deaths.value} duration={3} separation=","></CountUp></Typography>
                        <Typography color="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
